...
type TextPartResponse struct {
	...
	Mentions []TextPartResponseMention `json:"mentions" api:"nullable"`
...
type TextPartResponseMention struct {
...
// Returns the unmodified JSON received from the API
func (r TextPartResponseMention) RawJSON() string { return r.JSON.raw }
func (r *TextPartResponseMention) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
