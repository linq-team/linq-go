...
const (
	...
	WebhookEventTypeZeroDayRetentionUpdated                  WebhookEventType = "zero_day_retention.updated"
	WebhookEventTypePhoneNumberForwardingUpdated             WebhookEventType = "phone_number.forwarding_updated"
	WebhookEventTypeEnvironmentLineMoved                     WebhookEventType = "environment.line_moved"
	WebhookEventTypeContactCardCreated                       WebhookEventType = "contact_card.created"
	WebhookEventTypeContactCardUpdated                       WebhookEventType = "contact_card.updated"
	WebhookEventTypeContactCardDeleted                       WebhookEventType = "contact_card.deleted"
	WebhookEventTypeAPITokenCreated                          WebhookEventType = "api_token.created"
	WebhookEventTypeAPITokenRenamed                          WebhookEventType = "api_token.renamed"
	WebhookEventTypeAPITokenExpiryScheduled                  WebhookEventType = "api_token.expiry_scheduled"
	WebhookEventTypeAPITokenExpired                          WebhookEventType = "api_token.expired"
	WebhookEventTypeAPITokenActivated                        WebhookEventType = "api_token.activated"
	WebhookEventTypeAPITokenDeleted                          WebhookEventType = "api_token.deleted"
	WebhookEventTypeEnvironmentCreated                       WebhookEventType = "environment.created"
	WebhookEventTypeEnvironmentRenamed                       WebhookEventType = "environment.renamed"
	WebhookEventTypeEnvironmentDeleted                       WebhookEventType = "environment.deleted"
	WebhookEventTypeWebhookSubscriptionCreated               WebhookEventType = "webhook_subscription.created"
	WebhookEventTypeWebhookSubscriptionDeleted               WebhookEventType = "webhook_subscription.deleted"
	WebhookEventTypeWebhookSubscriptionTargetURLChanged      WebhookEventType = "webhook_subscription.target_url_changed"
	WebhookEventTypeWebhookSubscriptionEnabled               WebhookEventType = "webhook_subscription.enabled"
	WebhookEventTypeWebhookSubscriptionDisabled              WebhookEventType = "webhook_subscription.disabled"
	WebhookEventTypeWebhookSubscriptionEventsUpdated         WebhookEventType = "webhook_subscription.events.updated"
	WebhookEventTypeWebhookSubscriptionPhoneNumbersUpdated   WebhookEventType = "webhook_subscription.phone_numbers.updated"
	WebhookEventTypeWebhookSubscriptionRoutingHeadersSet     WebhookEventType = "webhook_subscription.routing_headers_set"
	WebhookEventTypeWebhookSubscriptionRoutingHeadersCleared WebhookEventType = "webhook_subscription.routing_headers_cleared"
	WebhookEventTypeTeamMemberAdded                          WebhookEventType = "team_member.added"
	WebhookEventTypeTeamMemberSignedIn                       WebhookEventType = "team_member.signed_in"
	WebhookEventTypeTeamMemberSignedOut                      WebhookEventType = "team_member.signed_out"
)
